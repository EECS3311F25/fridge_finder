...
one or more commit messages do not begin with the ticket number of the task followed by a short description of commit changes// at least one branch is not named after the associated single ticket number // unorganized Board
